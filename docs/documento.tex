...
\textbf{Implementação:} \href{https://github.com/BccMaterial/AA-Trabalho/blob/main/c/iceStatuesFestival.c}{Link para Implementação}

\textbf{Complexidade:} $\mathcal{O}(M \times N)$
