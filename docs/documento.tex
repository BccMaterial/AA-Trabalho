...
Quando todos os caracteres compreendidos entre o início da partição e a posição \texttt{end} foram analisados, tem-se a garantia de que nenhuma letra dessa partição aparecerá posteriormente na string. Assim, a partição pode ser encerrada com segurança.

O algoritmo funciona em \textbf{duas etapas}:
\begin{enumerate}
