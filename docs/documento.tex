...
\textbf{Implementação:} \href{https://github.com/BccMaterial/AA-Trabalho/blob/main/c/routeChange.c}{Link para Implementação}

\textbf{Complexidade:} $\mathcal{O}(N^2)$
...
\textbf{Implementação:} \href{https://github.com/BccMaterial/AA-Trabalho/blob/main/python/parenthesis.py}{./python/parenthesis}

\textbf{Complexidade:} $O(C_n)$ ou $O(4^n / n^(3/2))$
